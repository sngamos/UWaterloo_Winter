...
$$C = \mu+\sigma^2\sum_{i=1}^{N}{\ln{(1-x_i^a)}}$$ and,
$$D= \sigma^2N$$
...
Upon using kNN with 5-fold cross validation, we obtained the best k = 8, and the weighted kNN using distance has obtained a lower RMSE value of 0.5944 compared to the original kNN of 0.6711.
